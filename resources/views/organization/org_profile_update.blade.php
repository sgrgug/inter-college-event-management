            ...
            <div class="bg-white p-5 shadow rounded-md">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col py-10 space-y-2">
                        ...
                        @enderror
                        <input class="rounded-md border-gray-400" type="text" name="name" value="{{ $org->name }}">
                    </div>
                    ...
                    <div class="flex flex-col py-10 space-y-2">
                        ...
                        @error('location')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                        <input class="rounded-md border-gray-400" type="text" name="location" value="{{ $org->location }}">
                    </div>
